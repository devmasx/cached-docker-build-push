  ...
  it("#call", () => {
    ...
    expect(commands).toMatchInlineSnapshot(`
      Array [
        ...
        "docker build     --dockerfile Dockerfile.dev     --cache-from=image-name:cache-builder --cache-from=image-name:cache-test --cache-from=image-name     --target builder     -t image-name:cache-builder   .",
        "docker build     --dockerfile Dockerfile.dev     --cache-from=image-name:cache-builder --cache-from=image-name:cache-test --cache-from=image-name     --target test     -t image-name:cache-test   .",
